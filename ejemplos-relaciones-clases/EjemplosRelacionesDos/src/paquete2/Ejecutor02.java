...
public class Ejecutor02 {
    ...
    public static void main(String[] args) {
        ...
        Persona persona1 = new Persona("Dara Van Gijsel", "11028989217", barrio1);
        Persona persona2 = new Persona("Paula Monta", "15987465205", barrio2);
        Persona persona3 = new Persona("Sofia Vire", "1102458792", barrio3);
